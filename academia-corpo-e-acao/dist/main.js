...
/* harmony import */ var _components_usuario_usuario_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/usuario/usuario.component */ "./src/app/components/usuario/usuario.component.ts");
/* harmony import */ var _components_usuario_lista_usuario_lista_usuario_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/usuario/lista-usuario/lista-usuario.component */ "./src/app/components/usuario/lista-usuario/lista-usuario.component.ts");
/* harmony import */ var _components_usuario_cadastro_usuario_cadastro_usuario_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/usuario/cadastro-usuario/cadastro-usuario.component */ "./src/app/components/usuario/cadastro-usuario/cadastro-usuario.component.ts");
/* harmony import */ var _components_usuario_troca_senha_troca_senha_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/usuario/troca-senha/troca-senha.component */ "./src/app/components/usuario/troca-senha/troca-senha.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'usuario', component: _components_usuario_usuario_component__WEBPACK_IMPORTED_MODULE_20__["UsuarioComponent"], children: [
            { path: '', component: _components_usuario_lista_usuario_lista_usuario_component__WEBPACK_IMPORTED_MODULE_21__["ListaUsuarioComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_12__["AuthGuardService"]] },
            { path: ':usuario', component: _components_usuario_cadastro_usuario_cadastro_usuario_component__WEBPACK_IMPORTED_MODULE_22__["CadastroUsuarioComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_12__["AuthGuardService"]] }
        ] }
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_usuario_usuario_component__WEBPACK_IMPORTED_MODULE_20__["UsuarioComponent"],
                _components_usuario_lista_usuario_lista_usuario_component__WEBPACK_IMPORTED_MODULE_21__["ListaUsuarioComponent"],
                _components_usuario_cadastro_usuario_cadastro_usuario_component__WEBPACK_IMPORTED_MODULE_22__["CadastroUsuarioComponent"],
                _components_usuario_troca_senha_troca_senha_component__WEBPACK_IMPORTED_MODULE_23__["TrocaSenhaComponent"]
            ],
            imports: [
...
var EditarFichaTreinoComponent = /** @class */ (function () {
    function EditarFichaTreinoComponent(planoTreinoService) {
...
module.exports = "<section class=\"hero\">\r\n  <div class=\"hero-body\">\r\n\r\n    <div class=\"container\">\r\n      <div *ngIf=\"mensagemErro !== ''\" class=\"notification is-danger\" (click)=\"onNotificationClick()\">\r\n        <button class=\"delete\"></button>\r\n        <h4 class=\"title is-4 has-text-centered\">\r\n          {{ mensagemErro }}\r\n        </h4>\r\n      </div>\r\n\r\n      <div class=\"card\">\r\n        <header class=\"card-header\">\r\n          <h5 class=\"card-header-title title is-5 is-orange\">\r\n            Informações do Aluno\r\n          </h5>\r\n        </header>\r\n        <div class=\"card-content\">\r\n          <form #alunoForm=\"ngForm\" (ngSubmit)=\"onSubmit(alunoForm)\" novalidate>\r\n            <div class=\"field\">\r\n              <div class=\"control\">\r\n                <input class=\"input\" type=\"text\" placeholder=\"Nome\" name=\"nome\" ngModel required minlength=\"8\"\r\n                  maxlength=\"60\">\r\n              </div>\r\n            </div>\r\n            <div class=\"field\">\r\n              <div class=\"control\">\r\n                <input class=\"input\" type=\"text\" placeholder=\"Email\" name=\"email\" ngModel required minlength=\"6\" maxlength=\"60\">\r\n              </div>\r\n            </div>\r\n            <div class=\"field\">\r\n              <div class=\"control\">\r\n\r\n                <input class=\"input\" type=\"number\" placeholder=\"Peso\" name=\"peso\" ngModel required min=\"1\" max=\"999\">\r\n              </div>\r\n            </div>\r\n            <div class=\"field\">\r\n              <div class=\"control\">\r\n                <input class=\"input\" type=\"number\" placeholder=\"Altura\" name=\"altura\" ngModel required min=\"1\" max=\"999\">\r\n              </div>\r\n            </div>\r\n            <div class=\"field\">\r\n              <div class=\"control\">\r\n                <textarea class=\"input\" type=\"text\" placeholder=\"Observação\" name=\"obs\" ngModel required maxlength=\"1000\"></textarea>\r\n              </div>\r\n            </div>\r\n\r\n            <div class=\"is-pulled-right\">\r\n              <a type=\"button\" class=\"button is-danger\" [routerLink]=\"['/usuario']\">Voltar</a>\r\n              &nbsp;\r\n              <button type=\"submit\" class=\"button is-info\" [disabled]=\"!alunoForm.form.valid\">Salvar</button>\r\n            </div>\r\n          </form>\r\n        </div>\r\n\r\n      </div>\r\n    </div>\r\n  </div>\r\n</section>\r\n\r\n<section class=\"hero\">\r\n  <div class=\"hero-body\">\r\n\r\n    <div class=\"container\">\r\n      <div *ngIf=\"mensagemErro !== ''\" class=\"notification is-danger\" (click)=\"onNotificationClick()\">\r\n        <button class=\"delete\"></button>\r\n        <h4 class=\"title is-4 has-text-centered\">\r\n          {{ mensagemErro }}\r\n        </h4>\r\n      </div>\r\n\r\n      <div class=\"card\">\r\n        <header class=\"card-header\">\r\n          <h5 class=\"card-header-title title is-5 is-orange\">\r\n            Editar Cadastro\r\n          </h5>\r\n        </header>\r\n        <div class=\"card-content\">\r\n          <form #alunoForm=\"ngForm\" (ngSubmit)=\"onSubmit(alunoForm)\" novalidate>\r\n            <div class=\"field\">\r\n              <div class=\"control\">\r\n                <input class=\"input\" type=\"email\" placeholder=\"Email\" name=\"email\" ngModel required minlength=\"5\"\r\n                  maxlength=\"30\">\r\n              </div>\r\n            </div>\r\n            <div class=\"field\">\r\n                <div class=\"control\">\r\n                  <input class=\"input\" type=\"text\" placeholder=\"Celular\" name=\"celular\" ngModel required minlength=\"5\"\r\n                    maxlength=\"30\">\r\n                </div>\r\n              </div>            \r\n            <div class=\"field\">\r\n              <div class=\"control\">\r\n                <input class=\"input\" type=\"number\" placeholder=\"Peso\" name=\"peso\" ngModel required minlength=\"1\"\r\n                  maxlength=\"6\">\r\n              </div>\r\n            </div>\r\n            <div class=\"field\">\r\n              <div class=\"control\">\r\n                <input class=\"input\" type=\"number\" placeholder=\"Altura\" name=\"altura\" ngModel required minlength=\"6\">\r\n              </div>\r\n            </div>\r\n            <div class=\"is-pulled-right\">\r\n              <a type=\"button\" class=\"button is-danger\" [routerLink]=\"['/usuario']\">Voltar</a>\r\n              &nbsp;\r\n              <button type=\"submit\" class=\"button is-info\" [disabled]=\"!alunoForm.form.valid\">Salvar</button>\r\n            </div>\r\n          </form>\r\n        </div>\r\n\r\n      </div>\r\n    </div>\r\n  </div>\r\n</section>"
...
var CadastroUsuarioComponent = /** @class */ (function () {
    function CadastroUsuarioComponent(router, route, planoTreinoService, authService) {
        this.router = router;
        this.route = route;
        this.planoTreinoService = planoTreinoService;
        this.authService = authService;
    ...
    CadastroUsuarioComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.planoTreinoService.obterUsuarios(params['usuario']).subscribe(function (usuario) {
                if (usuario.length) {
    ...
    CadastroUsuarioComponent.prototype.onSubmit = function (loginForm) {
        ...
        if (loginForm.valid) {
            ...
            this.authService.trocarSenha(usrSenha).subscribe(function (resp) {
                console.log(resp);
                _this.mensagemErro = '';
...
var ListaUsuarioComponent = /** @class */ (function () {
    function ListaUsuarioComponent(router, planoTreinoService) {
        this.router = router;
        this.planoTreinoService = planoTreinoService;
    }
...
/***/ "./src/app/components/usuario/troca-senha/troca-senha.component.css":
/*!**************************************************************************!*\
  !*** ./src/app/components/usuario/troca-senha/troca-senha.component.css ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/usuario/troca-senha/troca-senha.component.html":
/*!***************************************************************************!*\
  !*** ./src/app/components/usuario/troca-senha/troca-senha.component.html ***!
  \***************************************************************************/
/*! no static exports found */
...
module.exports = "<section class=\"hero\">\n  <div class=\"hero-body\">\n\n    <div class=\"container\">\n      <div *ngIf=\"mensagemErro !== ''\" class=\"notification is-danger\" (click)=\"onNotificationClick()\">\n        <button class=\"delete\"></button>\n        <h4 class=\"title is-4 has-text-centered\">\n          {{ mensagemErro }}\n        </h4>\n      </div>\n\n      <div class=\"card\">\n        <header class=\"card-header\">\n          <h5 class=\"card-header-title title is-5 is-orange\">\n            Trocar Senha\n          </h5>\n        </header>\n        <div class=\"card-content\">\n          <form #alunoForm=\"ngForm\" (ngSubmit)=\"onSubmit(alunoForm)\" novalidate>\n            <div class=\"field\">\n              <div class=\"control\">\n                <input class=\"input\" type=\"login\" placeholder=\"Login\" name=\"login\" ngModel required minlength=\"8\"\n                  maxlength=\"30\" readonly>\n              </div>\n            </div>\n            <div class=\"field\">\n              <div class=\"control\">\n                <input class=\"input\" type=\"password\" placeholder=\"Senha\" name=\"password\" ngModel required #senha\n                  minlength=\"6\">\n              </div>\n            </div>\n            <div class=\"field\">\n              <div class=\"control\">\n                <input class=\"input\" type=\"password\" placeholder=\"Confirmar Senha\" name=\"confirmPassword\" ngModel required #confirmarSenha\n                  minlength=\"6\">\n              </div>\n            </div>            \n            <br>\n            <div class=\"is-pulled-right\">\n              <a type=\"button\" class=\"button is-danger\" [routerLink]=\"['/usuario']\">Voltar</a>\n              &nbsp;\n              <button type=\"submit\" class=\"button is-info\"\n                [disabled]=\"!alunoForm.form.valid\">Salvar</button>\n            </div>\n          </form>\n          <br>\n        </div>\n      </div>\n    </div>\n  </div>\n</section>"

/***/ }),

/***/ "./src/app/components/usuario/troca-senha/troca-senha.component.ts":
/*!*************************************************************************!*\
  !*** ./src/app/components/usuario/troca-senha/troca-senha.component.ts ***!
  \*************************************************************************/
/*! exports provided: TrocaSenhaComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TrocaSenhaComponent", function() { return TrocaSenhaComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var TrocaSenhaComponent = /** @class */ (function () {
    function TrocaSenhaComponent() {
    }
    TrocaSenhaComponent.prototype.ngOnInit = function () {
    };
    TrocaSenhaComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-troca-senha',
            template: __webpack_require__(/*! ./troca-senha.component.html */ "./src/app/components/usuario/troca-senha/troca-senha.component.html"),
            styles: [__webpack_require__(/*! ./troca-senha.component.css */ "./src/app/components/usuario/troca-senha/troca-senha.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], TrocaSenhaComponent);
    return TrocaSenhaComponent;
}());
...
module.exports = "\r\n<div class=\"center\">\r\n    <h3 class=\"title is-4\">Editar Aluno</h3>\r\n</div>\r\n<router-outlet></router-outlet>"
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.getHeaders = function () {
        ...
        if (!Object(util__WEBPACK_IMPORTED_MODULE_0__["isNullOrUndefined"])(token))
    ...
    AuthService.prototype.autenticar = function (credentials) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiBaseUrl + "/api/auth", credentials, { headers: this.getHeaders() })
    ...
    AuthService.prototype.trocarSenha = function (usrSenha) {
        return this.http.patch(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiBaseUrl + "/api/usuario", usrSenha, { headers: this.getHeaders() })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (resp) {
            console.log(resp);
            return resp;
        }));
    ...
    AuthService.prototype.confirmarEmail = function (email, id) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiBaseUrl + "/api/auth/" + email + "/" + id, {
